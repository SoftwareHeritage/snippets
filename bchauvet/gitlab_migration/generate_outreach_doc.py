...
YEAR = 2023
BOARD_URL = "https://gitlab.softwareheritage.org/groups/outreach/-/milestones"
...
def write_milestones(output):
    ...
    for i in range(len(goals)):
        ...
        for milestone in milestones[i]:
            if milestone.title.lower().endswith(prefix.lower()):
...
output = open(f"./docs/outreach-{YEAR}.rst", "w")
